...
- Data-driven simulation of patient flow in a hospital or demand clustering for diagnostics
- Linking with `gasmixer.py` style simulations for utility under resource constraints

## 🌱 Reflections
This is a powerful intersection of logic, probability, and impact. It helps me think about startups, medical operations, and infrastructure from a systems optimization perspective. I plan to combine this with thermodynamics and biology later.

## 🛠 Tools Used
- Python
- Matplotlib
- ChatGPT for feedback and debugging

## ⚡ Future Goals
- Introduce randomness and confidence intervals to decisions
